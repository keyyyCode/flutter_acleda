  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: [
          _buildPaymentOption(
              context, 'assets/icons/menu/coinloan.png', 'REQUEST LOAN'),
          _buildPaymentOption(context, 'assets/icons/menu/loanagain.png',
              'LOAN AGAINST TERM DEPOSIT'),
          _buildPaymentOption(
              context, 'assets/icons/menu/loanwrite.png', 'LOAN SUMMARY'),
          _buildPaymentOption(
              context, 'assets/icons/menu/loansearch.png', 'CBU CREDIT REPORT'),
        ],
      ),
    );
  }
