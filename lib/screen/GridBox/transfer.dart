  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: [
          _buildPaymentOption(
              context, 'assets/icons/transfer/ownaccounts.png', 'OWN ACCOUNTS'),
          _buildPaymentOption(
              context,
              'assets/icons/transfer/acledatransfer.png',
              'ACLEDA ACCOUNT/PHONE NUMBER'),
          _buildPaymentOption(context,
              'assets/icons/transfer/transferlocal.png', 'LOCAL TRANSFER'),
          _buildPaymentOption(
              context,
              'assets/icons/transfer/globeltransfer.png',
              'INTERNATIONAL TRANSFERS'),
          _buildPaymentOption(context,
              'assets/icons/transfer/trandingaccount.png', 'TRANDING ACCOUNTS'),
